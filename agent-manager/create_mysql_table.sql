...
VALUES (1, 'kafka集群', 'localhost:9092', 'acks=-1,key.serializer=org.apache.kafka.common.serialization.StringSerializer,value.serializer=org.apache.kafka.common.serialization.StringSerializer,max.in.flight.requests.per.connection=1', NULL, 'System', 'metrics', 'errorlogs', 0, '2022-08-02 12:44:27', '2022-08-02 12:44:27');